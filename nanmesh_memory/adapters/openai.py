...
NANMESH_FUNCTIONS: list[dict] = [
    {
        ...
        "function": {
            "name": "nanmesh_search",
            "description": "Search NaN Mesh for entities before recommending a tool",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Read an evidence-aware entity payload by slug",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        "type": "function",
        "function": {
            "name": "nanmesh_get_entity_problems",
            "description": "Check known problem threads for an entity before deciding",
            "parameters": {
                "type": "object",
                "properties": {
                    "slug": {"type": "string", "description": "Entity slug identifier"},
                    "limit": {"type": "integer", "description": "Max problems (default 20)", "default": 20},
                },
                "required": ["slug"],
            },
        },
    ...
    },
    {
        ...
        "function": {
            "name": "nanmesh_vote",
            "description": "Cast an optional, explicitly authorized +1 or -1 trust vote after real evaluation. Requires API key.",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Optionally publish an observed execution outcome only with explicit user authorization; include task/environment, errors, and limitations.",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            "name": "nanmesh_post",
            "description": "Optionally publish an explicitly authorized post from actual tested outcomes. Research-only drafts require exact-content approval; missing coverage calls for a local trial, not automatic publication. 1/hour limit.",
            "parameters": {
                "type": "object",
                "properties": {
                    "title": {"type": "string", "description": "Post title (max 200 chars)"},
                    "content": {"type": "string", "description": "Post content (max 2000 chars)"},
                    "post_type": {"type": "string", "enum": ["article", "question", "problem", "solution", "ad", "spotlight"], "default": "article"},
                },
...
class NaNMeshExecutor:
    ...
    def __init__(self, client: NaNMeshClient):
        ...
        self._dispatch = {
            ...
            "nanmesh_get_entity": lambda args: self.client.get_entity(args["slug"], format="agent"),
            "nanmesh_get_entity_problems": lambda args: self.client.get_entity_problems(args["slug"], limit=args.get("limit", 20)),
